var Experigen =  {
	...
	experimentName: "test2ident", // use only A-Z, a-z, 0-9
	
	databaseServer: "http://db.phonologist.org/",
	sourceHtml: "https://s3.amazonaws.com/experigendata/testexperigen/web/identtrainingindex.html",
	version: "ns",
	...
	items: "resources/items_Ident_training.txt",
	
	otherresources: {
	    test_items: "resources/items_Ident_training.txt",
	...
	folders: {
	    views: "views/ident/",
	    practice_sounds: "resources/Sounds_Ident/",
	    sounds: "resources/Sounds_Ident/",
	    test_sounds: "resources/Sounds_Ident/",
