...
Experigen.recordMain = function (userResponse){
	var prompt = 'Press the button to get to the next file.';
	this.mainResponses.push(userResponse);
...
Experigen.initialize = function () {	
	...
	var trainingBlock = []
						...
						.shuffle();							
	var oneCycle = items.pairWith("view", "ident.ejs");
	var mainBlock = []
		NCYCLES = 2; 
	...
	var prop;
	this.sectionStart = 0;
	this.addStaticScreen("getinfo.ejs");
	this.addStaticScreen("introident.ejs");
