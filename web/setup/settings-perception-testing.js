...
Experigen.settings = {
		...
		experimentName: "testperceptionitems", // use only A-Z, a-z, 0-9
		
		databaseServer: "http://db.phonologist.org/",
		sourceHtml: "https://experigendata.s3.amazonaws.com/testexperigen/web/PTblock" + Experigen.block + ".html",
		version: "ns",
		...
		items: "resources/items_PT.txt",
		
		otherresources: {
			practice_items: "resources/items_PT.txt",
			catch_items: "resources/items_PT.txt",
		},
